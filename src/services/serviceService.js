const serviceAPI = {
  ...
  getServiceById: async (serviceId) => {
    try {
      const response = await fetch(`http://${process.env.REACT_APP_API_URL}/services/${serviceId}`, {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
        }
  ...
  bookService: async (serviceId, bookingData) => {
    try {
      const response = await fetch(`http://${process.env.REACT_APP_API_URL}/services/${serviceId}/book`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
