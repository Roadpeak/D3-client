// ProfileLayout.jsx - Shared layout for all profile pages
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-80">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
              ...
              <Link 
                to="/profile/settings"
                className="w-full text-blue-600 py-2 rounded-lg font-medium hover:bg-blue-50 transition-colors block text-center"
              >
                Edit Profile
              </Link>
            </div>
