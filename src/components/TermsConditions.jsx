const TermsConditions = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 transition-colors duration-200">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-800 p-8 transition-colors duration-200">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">3. User Responsibilities</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Service Bookings and Payments</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. Prohibited Activities</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. Intellectual Property</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">8. Privacy</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. Modifications to Terms</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <br />
              <span className="text-blue-600 dark:text-blue-400">Email: info@discoun3ree.com</span>
            </p>
          </section>
        </div>
      </div>
