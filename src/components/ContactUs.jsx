            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Nairobi(k)</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">0743007000</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">support@discoun3ree.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-gray-600 dark:text-gray-400">Reach out anyday anytime</p>
                </div>
              </div>
            </div>
          </div>
...
${message}`;
              ...
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                >
                  Send Message
                </button>
              </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Need Quick Answers?</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Check out our Frequently Asked Questions for instant answers to common inquiries.
            </p>
            <Link to="/faq" className="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-medium py-2 px-4 rounded-lg transition-colors inline-block">
              View FAQ
            </Link>
          </div>
        </div>
