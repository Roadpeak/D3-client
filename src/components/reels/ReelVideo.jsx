    ...
    const handleVideoClick = () => {
        if (videoRef.current) {
            if (isPlaying) {
                ...
                // Playing - hide controls immediately
                videoRef.current.play();
                setIsPlaying(true);
                setShowControls(false);
            }

            // Auto-hide controls after 1 second if paused
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-full max-w-[450px] mx-auto bg-black">
                ...
                {/* Right Side Actions */}
                <div className="absolute right-3 bottom-24 flex flex-col space-y-5 pointer-events-auto z-20">
                    {/* Like Button */}
                    <button
